...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this._elemArrowBtn = $('<button type="button" id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn"><span class="comboTreeArrowBtnImg"><b role="presentation"></b></span></button>');
